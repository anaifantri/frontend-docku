  ...
  return (
    <>
      <div className="flex-all-center w-full h-screen top-0 bg-teal-50">
        <div className="flex-all-center bg-white w-150 h-120 border-slate-100 rounded-4xl drop-shadow-xl">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit}>
                <div className="flex-all-center mt-6">
                  <div>
                    <label className="text-teal-900">New Password</label>
                    <input
                      type="password"
                    ...
                    <label className="text-teal-900 mt-4 flex">
